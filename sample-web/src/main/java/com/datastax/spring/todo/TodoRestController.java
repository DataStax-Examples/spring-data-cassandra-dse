package com.datastax.spring.todo;
...
import t03.repository.spring.s01.TodoEntity;
import t03.repository.spring.s01.TodoRepositoryCassandra;
...
public class TodoRestController {
    ...
    public ResponseEntity<Todo> update(HttpServletRequest req, 
            @PathVariable(value = "uid") String uid, @RequestBody Todo todoReq) 
    throws URISyntaxException {
