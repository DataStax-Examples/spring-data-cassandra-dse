 ...
 */
public class Test01_Reactive implements ExampleSchema {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(Test01_Reactive.class);
