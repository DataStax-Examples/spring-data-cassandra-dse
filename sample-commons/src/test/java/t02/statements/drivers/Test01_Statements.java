 ...
 */
public class Test01_Statements implements ExampleSchema {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(Test01_Statements.class);

    @Test
    public void learnStatements () {
