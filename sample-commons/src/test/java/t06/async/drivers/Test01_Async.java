 ...
 */
public class Test01_Async implements ExampleSchema {

    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(Test01_Async.class);
    ...
    private static CompletableFuture< Optional < UserDto > > findUserByIdAsync(String email) {
        return session.executeAsync(stmtFindUser.bind(email))
                      .thenApply(Test01_Async::mapUserDtoRow)
                      .toCompletableFuture();
    }
