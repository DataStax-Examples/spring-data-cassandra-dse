 ...
 */
public class Test01_Batches implements ExampleSchema {
    
    /** Logger for the class. */
    private static Logger LOGGER = LoggerFactory.getLogger(Test01_Batches.class);
