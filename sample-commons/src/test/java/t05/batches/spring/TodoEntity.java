...
@Table(value = TodoEntity.TODO_TABLENAME)
public class TodoEntity {
    
    public static final String TODO_TABLENAME        = "todos";
    public static final String TODO_COLUMN_UID       = "uid";
    public static final String TODO_COLUMN_TITLE     = "title";
    public static final String TODO_COLUMN_COMPLETED = "completed";
    public static final String TODO_COLUMN_ORDER     = "offset";
    
    @PrimaryKey
    @Column(TODO_COLUMN_UID)
    @CassandraType(type = Name.UUID)
    private UUID uid;
    
    @Column(TODO_COLUMN_TITLE)
    @CassandraType(type = Name.TEXT)
    private String title;
    
    @Column(TODO_COLUMN_COMPLETED)
    @CassandraType(type = Name.BOOLEAN)
    private boolean completed = false;
    
    @Column(TODO_COLUMN_ORDER)
